...
```text
Insany — information security specialist.

I design and build low-level security tools and terminal-first
utilities, with a focus on predictability, minimal dependencies,
and offline operation. My work centers around systems programming
and security tooling that can be audited, reasoned about, and
deployed without external services.
```
